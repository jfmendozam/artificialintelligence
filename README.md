...
```
1.16.6 [Estructura general del código](workshops/pag57/IA_Guía_DFS_BFS.pdf) <--> [![Python(https://img.shields.io/badge/Python - file_search.py -3776AB?logo=python&logoColor=fff)](workshops/pag57/file_search.py)
```text
